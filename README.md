...
"JSSX" converts Suitelet UI calls from being verbose and loose spaghetti code into hierarchical, modern, component-based UI architecture as seen in popular JavaScript frameworks like React.

We're not reinventing the wheel, we're just leveraging the jsx syntax to make SuiteScript UI's exponentially easier/faster to develop, maintain and read.

# What is JSX?

[Official JSX docs](https://facebook.github.io/jsx/)

But it's even simpler with "JSSX". The Babel compiler will be able to parse JSX Elements all on their own. No need to have the JSX be the return of a greater UI function/class component like in React development.

Simply add the tags, props and nesting as needed to build your UI. Run the transpile command with the .jsx file that you're transpiling and "JSSX" will append your SuiteScript below your JSX.

Copy and paste this SuiteScript into your project and voila!
...
You can of course include your own component ids so that you can adopt this dev tool to an existing Suitelet!
